...
1. **Today:** 14 diagnostic endpoints, a nightly-scanned trust registry across five sources ([dashboard](https://agenthealthmonitor.xyz/dashboard)), pre-transaction health checks.
