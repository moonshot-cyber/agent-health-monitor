...
# AHM_VALUE_PROPOSITIONS.md used to be regenerated here from the DB. It was
# a fourth source of ecosystem figures that other docs cited as canonical,
# but the scan writes to an ephemeral container filesystem and was never
# committed back — so the file in git froze while the running copy was
# invisible. Changing figures now live on /dashboard only; see
